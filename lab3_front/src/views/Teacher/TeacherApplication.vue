<template>
  <div class="main_part">
      ...
      <el-table :data="tableData" style="width: 1200px" border stripe>
        ...
        <el-table-column prop="teacherName" label="教师姓名" width="150" v-if="false"/>
        <el-table-column prop="major" label="开课专业" width="150" v-if="false"/>
        <el-table-column prop="school" label="开课院系" width="150" v-if="false"/>
        ...
        <el-table-column prop="applyType" label="申请类型" width="0" v-if="false"/>
