  ...
  <div class="main_part">
    <div>
      ...
      <el-table :data="tableData" style="width: 100%" border stripe>
        <el-table-column fixed prop="number" label="工号" width="80" sortable/>
        ...
        <el-table-column prop="teaStatus" label="状态" width="80" />
...
export default {
  ...
  methods:{
    ...
    save:function (){
      this.addTeacher.school = this.add_school_major[0]
      this.addTeacher.major = this.add_school_major[1]
