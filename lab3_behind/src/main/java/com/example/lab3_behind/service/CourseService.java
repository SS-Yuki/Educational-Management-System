...
public interface CourseService {
    ...
    List<Course> findALLStudiedCourseOfStudent(String stuNum) throws Exception;
    ...
    List<Course> findAPageCourseOfTeacher(String jobNum, SchoolYear schoolYear, Semester semester) throws Exception;
